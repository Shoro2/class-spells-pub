...
Cross reference: [`share-public/docs/World of Warcraft/06-custom-ids.md`](https://github.com/Shoro2/share-public/blob/master/docs/World%20of%20Warcraft/06-custom-ids.md) for the global ID spaces of all mods (100xxx Paragon, 920xxx cursed marker, 950xxx passive enchants, etc.).
