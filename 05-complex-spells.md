...
| Spell | File | Risk |
|-------|-------|--------|
| 901102 Extra Attack 25 % | [global](global.md) | repeats the last attack — the extra attack must not proc itself |
| 900304 DK → Death Coil proc | [death-knight-blood](death-knight-blood.md) | Death Coil has its own proc pipeline |
| 900274 Pala CS/Judge/DS → Exorcism buff | [paladin-retribution](paladin-retribution.md) | Exorcism cast consumes the buff but must not regrant it |
| 900900 Disc Shield Explosion | [priest-discipline](priest-discipline.md) | the explosion cast must not trigger another shield removal |
| 901103 Global 10 % AoE proc | [global](global.md) | damage helper on 10 targets must not trigger 10 more AoE procs |
| 900800 / 900966 DoT → shadow AoE | [warlock-affliction](warlock-affliction.md), [priest-shadow](priest-shadow.md) | the AoE damage must not trigger another DoT-tick proc |
...
|-------|-------|-----------|
| 900802 Warlock DoT spread | [warlock-affliction](warlock-affliction.md) | 1 → 3 → 9 → 27 targets in 3 ticks |
| 900967 Priest DoT spread | [priest-shadow](priest-shadow.md) | identical — code shareable |
| 901103 global AoE proc | [global](global.md) | 10 targets/hit × many hits/sec |
| 900533 Hunter Auto Shot bounce | [hunter-marksmanship](hunter-marksmanship.md) | 9 targets per Auto Shot, fast auto-attack frequency |
...
| Spell | Variant | File |
|-------|----------|-------|
| 900435 Shaman summons +50 % | TBD (currently marker only) | [shaman-enhancement](shaman-enhancement.md) |
| 900502 BM Pet damage +50 % | 1 | [hunter-beast-mastery](hunter-beast-mastery.md) |
| 900503 BM Pet speed +50 % | PlayerScript tick | [hunter-beast-mastery](hunter-beast-mastery.md) |
| 900437 Spirit Wolves inherit haste | on summon (3) | [shaman-enhancement](shaman-enhancement.md) |
| 900836 Imp Firebolt +50 % | 3 | [warlock-demonology](warlock-demonology.md) |
| 900839 Felguard +50 % | 2 | [warlock-demonology](warlock-demonology.md) |
| 901067 Druid summons scale with healing power | PlayerScript tick | [druid-restoration](druid-restoration.md) |
...
| Spell | Use case | File |
|-------|----------|-------|
| 900900 Disc Shield Explosion | explosion only on FADE or ENEMY_BREAK, not on right-click cancel | [priest-discipline](priest-discipline.md) |
| 901068 Druid summon death heal | heal only when the summon dies, not on despawn-by-owner-logout | [druid-restoration](druid-restoration.md) |
| 900833 Demo Meta duration extend | only on a kill event while the aura is active — OnRemove is irrelevant here, but the duration manipulation must not remove the aura itself | [warlock-demonology](warlock-demonology.md) |
...
Channels need more — there `SPELL_AURA_CAST_WHILE_WALKING` (aura 330) on the 901100 aura is additionally required. Detail: [global.md](global.md).
...
| 900205/900234/900268 Consecration around you | `Consecration` (48819): TargetA → `TARGET_DEST_CASTER` | [paladin-holy](paladin-holy.md) |
| 900270 Divine Storm +6 targets | `Divine Storm` (53385): `MaxAffectedTargets` → 10 | [paladin-retribution](paladin-retribution.md) |
| 900709 Blink target location | `Blink` (1953): TargetType → `TARGET_DEST_DEST` (ground target cursor) | [mage-arcane](mage-arcane.md) |
| 900737 Fire Blast off-GCD | `Fire Blast` (42873): `StartRecoveryCategory` = 0 | [mage-fire](mage-fire.md) |
| 900770 Water Elemental permanent | summon duration → -1 or very high | [mage-frost](mage-frost.md) |
...
| Spell | Hook | File |
|-------|------|-------|
| 900438 Wolf CL on hit | `UnitScript::OnDamage` | [shaman-enhancement](shaman-enhancement.md) |
| 900502 / 900504 BM Pet damage / cleave | `UnitScript::OnDamage` | [hunter-beast-mastery](hunter-beast-mastery.md) |
| 901068 Druid summon death heal | `UnitScript::OnUnitDeath` | [druid-restoration](druid-restoration.md) |
| 901069 Druid Thorns → Rejuv | `UnitScript::OnDamage` (on Victim=Player) | [druid-restoration](druid-restoration.md) |
...
|-------|-------------------|-------|
| 901100 Cast while moving | active for all casters at once — channel + cast + interruptible | [global](global.md) |
| 901102 Extra Attack 25 % | recursive procs | [global](global.md) |
| 901103 10 % AoE proc | spam on DoT ticks | [global](global.md) |
| 900802 Warlock DoT spread | exponential propagation | [warlock-affliction](warlock-affliction.md) |
| 900835 Lesser demons | custom creature templates per pet type + AI | [warlock-demonology](warlock-demonology.md) |
| 900840 Sacrifice all bonuses | identify and stack multiple pet-type buffs at once | [warlock-demonology](warlock-demonology.md) |
| 900833 + 900834 Demo Meta combo | permanently transformed AoE healer-tank hybrid | [warlock-demonology](warlock-demonology.md) |
| 900900 Disc Shield Explosion | OnRemove detection + damage scaling on the absorb amount | [priest-discipline](priest-discipline.md) |
| 900933 Heal → Holy Fire AoE | direct-heal-vs-HoT filter | [priest-holy](priest-holy.md) |
| 900701 Mage mana regen scaling | dynamic computation per regen tick | [mage-arcane](mage-arcane.md) |
| 900709 Blink target location | client-side ground target cursor | [mage-arcane](mage-arcane.md) |
| 900738 Pyro → Hot Streak loop | guaranteed instant Pyro chain, balance-critical | [mage-fire](mage-fire.md) |
| 900771 Frost Comet Shower | entirely new spell with custom visuals | [mage-frost](mage-frost.md) |
| 900534 Hunter Multi-Shot Barrage | 20 Multi-Shots in 2 s, performance | [hunter-marksmanship](hunter-marksmanship.md) |
| 900300 / 900301 DK triple DRW + double-cast | aura stacking issues on triggered re-cast | [death-knight-blood](death-knight-blood.md) |
| 900333 Frost Wyrm | custom NPC + AI + scaled Frost Breath | [death-knight-frost](death-knight-frost.md) |
| 900274 Pala Exorcism buff | stacking buff with consumption on Exorcism cast | [paladin-retribution](paladin-retribution.md) |
| 900407 Sham LvB instant via Clearcasting | cast-time modifier on a spell that can already be made instant | [shaman-elemental](shaman-elemental.md) |
| 901071 Druid HoT 2x ticks/duration | ticks vs. duration trade-off | [druid-restoration](druid-restoration.md) |
